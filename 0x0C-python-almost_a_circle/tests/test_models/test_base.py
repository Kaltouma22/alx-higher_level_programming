#!/usr/bin/python3
"""Module for testing and checking the Base Class."""
import unittest
...
class TestBase(unittest.TestCase):
    """Unit tests the Base class."""

    def setUp(self):
        """Set up test environment and initialize class attributes."""
    ...
    def test_A_nb_objects_private(self):
        """Test if nb_objects is private class attr."""
    ...
    def test_D_constructor_args_2(self):
        """Test constructor signature with two notself arguments."""
        with self.assertRaises(TypeError) as e:
    ...
    def test_G_id_keyword(self):
        """Test id passed as keyword argument."""
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)
    ...
    def test_H_test_from_json_string(self):
        ...
        s = '[{"x": 1, "y": 2, "width": 3, "id": 4, "height": 5}, {"x": 101,\
                "y": 20123, "width": 312321, "id": 522244, "height": 34340}]'
        d = [{'x': 1, 'y': 2, 'width': 3, 'id': 4, 'height': 5},
             {'x': 101, 'y': 20123, 'width': 312321, 'id': 522244,
             'height': 34340}]
